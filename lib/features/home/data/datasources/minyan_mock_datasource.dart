...
class MockMinyanRemoteDataSource implements MinyanRemoteDataSource {
  ...
  void _initializeMockData() {
    ...
    _mockMinyans.addAll([
      ...
      // New York - Manhattan (NEAR USER LOCATION)
      Minyan(
        id: '13',
        userId: 'user888',
        prayerType: 'Shacharit',
        date: todayStr,
        time: '07:00',
        locationName: 'Upper West Side Minyan',
        latitude: 40.7850,
        longitude: -73.9760,
        notes: 'Morning minyan on Upper West Side - Modern Orthodox',
        status: 'published',
        participantCount: 12,
        createdAt: DateTime.now(),
        updatedAt: DateTime.now(),
      ...
      // New York - Lower Manhattan (NEAR USER LOCATION)
      Minyan(
        id: '14',
        userId: 'user999',
        prayerType: 'Mincha',
        date: todayStr,
        time: '13:00',
        locationName: 'Financial District Minyan',
        latitude: 40.7070,
        longitude: -74.0113,
        notes: 'Afternoon minyan for financial district professionals',
        status: 'published',
        participantCount: 8,
        createdAt: DateTime.now(),
        updatedAt: DateTime.now(),
      ...
      // New York - Brooklyn (NEAR USER LOCATION)
      Minyan(
        id: '15',
        userId: 'user1000',
        prayerType: 'Maariv',
        date: tomorrowStr,
        time: '18:00',
        locationName: 'Brooklyn Heights Shul',
        latitude: 40.6948,
        longitude: -73.9887,
        notes: 'Evening minyan with learning program after prayers',
        status: 'published',
        participantCount: 10,
        createdAt: DateTime.now(),
        updatedAt: DateTime.now(),
